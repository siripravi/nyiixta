...
invApp.factory('getInvItems', function ($http, $q){
    ...
    this.getlist = function(i,j){  
        ...
        return $http({
            method: 'POST',
            url: '/admin/nyiixta/statement/doc-items?docId=' +i+"&invId="+ j,
...
invApp.controller('InvCtrl',function ($scope,$http, $window,$timeout,getInvItems) {
  ...
  /* getInvItems.getlist($scope.kf,$scope.header.invoice_id).success(function(response)
    ...
    $http.get('/admin/nyiixta/statement/doc-items?docid=' +$scope.kf+"&invid="+ $scope.header.invoice_id)
    ...
    $scope.saveItems = function(){
        ...
        $http({
            method: 'POST',
            url: '/admin/nyiixta/statement/doc-items?docid=' + $scope.kf+"&invid="+$scope.header.invoice_id+"&custid="+$scope.header.customer_id+
