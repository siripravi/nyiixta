        ...
        <div class="col-md-2 float-right">
            <ng-form>
                <fieldset ng-disabled="isSaving" ng-show="invForm.$dirty">
                    <?php $event = null; ?>
                    <a class="btn btn-primary btn-warning" style="margin-left: 1em" id="submit_item_button" ng-click="load($event)" name="myButton" role="button" aria-disabled="true"><i class="pe-7s-diskette"></i>
                        SAVE</a>
                    ...
                    <tr class="grid-row ng-scope" ng-repeat="item in invoice.items" ng-hide="item.status == 3">
                        ...
                        <td>
                            <div class="mailbox-controls" style="padding:5px;">
                                <a class="rowOption  btn btn-sm" href="javascript:void(0)" ng-click="modify($index + 1)">
                                    <span class="material-icons">
                                        edit </span>
                                </a>
                                &nbsp;&nbsp;
                                <a class="rowOption" title="Delete row (Ctrl+Delete)" ng-hide="editingData[$index + 1]" ng-click="deleteRow($index)"> <span class="material-icons">
                                        delete_outline </span>
